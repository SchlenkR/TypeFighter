...
let typeBuilder = mb.DefineType("Test")

// let getIntMethod = DynamicMethod("GetInt", typeof<string>, [| typeof<string> |], typeof<string>)
let methodName = "GetInt"
let getIntMethod = typeBuilder.DefineMethod(methodName, MethodAttributes.Public, typeof<string>, [| typeof<string> |])
...
let compiledType = typeBuilder.CreateTypeInfo()
let inst = Activator.CreateInstance(compiledType)
let compiledMethod = compiledType.GetMethod(methodName, BindingFlags.Public ||| BindingFlags.Instance)
let res = compiledMethod.Invoke(inst, [| "23" |])
